...
import { ArrowRight, BarChart3, Box, Check, ChevronRight, CircleDot, Compass, Copy, Download, FileText, Flame, LayoutDashboard, Play, Search, Settings, Sparkles, Target, Zap } from "lucide-react";
